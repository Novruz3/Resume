            ...
            <main className="section">
                ...
                <ul className="content-list">
                        <li className="content-list__item">
                            ...
                            <p className='skills__item'>HTML, CSS, Javascript, Bootstrap, React JS, Next JS, Typescript, Tailwind CSS, Redux Toolkit, Zustand, Github, Axios, Rest API, Node JS, Express JS, PostgreSQL, MySQL, Mongo DB, Sequlize</p>
                        </li>
                        <li className="content-list__item">
